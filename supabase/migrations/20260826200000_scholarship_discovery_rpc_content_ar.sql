-- Include content_ar in scholarship discovery RPC rows for Arabic card localization.
-- The paged CTE explicitly lists columns and previously omitted content_ar.
