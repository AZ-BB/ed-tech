-- Include requirement columns in discovery RPC rows so student detail modal can show
-- IELTS/TOEFL minimums, SAT policy, other eligibility, and documents from core columns.
