-- Optional saved-scholarship filter for discovery RPC (favourites toggle).

DROP FUNCTION IF EXISTS public.rpc_scholarships_discovery_page(text, text, text, text, text, text, int, int);
