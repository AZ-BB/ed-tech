-- Include active scholarships without discovery_payload in student discovery.
-- CSV/admin rows often have core columns + scholarship_destinations only; the RPC
-- previously required discovery_payload and hid ~50% of the catalog.
