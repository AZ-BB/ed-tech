...
export const metadata: Metadata = {
  title: "Reset password | Univeera",
  description: "Set a new password for your Univeera account.",
};
...
function ResetPasswordFallback() {
  return (
    <p className="text-sm leading-relaxed text-[#6a6a6a]">Loading reset form…</p>
  );
}
