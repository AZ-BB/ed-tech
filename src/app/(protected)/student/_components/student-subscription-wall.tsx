...
import {
  confirmCustomSubscriptionPaymentAction,
...
export function StudentSubscriptionWall({ displayPrice }: { displayPrice: string }) {
  ...
  const paymentCanceled = searchParams.get("subscription") === "canceled";
  ...
  useEffect(() => {
    ...
    startConfirmTransition(async () => {
      const result = await confirmCustomSubscriptionPaymentAction(sessionId);
  ...
  function handleSubscribe() {
    ...
    startPayTransition(async () => {
      const result = await createCustomSubscriptionCheckoutAction();
