...
import {
  ...
  type AdminAdvisorSessionsPanelProps,
...
export function AdminAdvisorSessionsTab({
  rows,
  totalRows,
  page,
  limit,
  status,
  statusCounts,
}: AdminAdvisorSessionsPanelProps) {
  ...
  return (
    <SchoolStudentPanel
      head="Booked sessions"
      sub="All advisor sessions — filter by status"
    >
