...
export function AdminAdvisorApplicationsTab({
  rows,
  totalRows,
  page,
  limit,
  ...
  return (
    <SchoolStudentPanel
      head="Assigned applications"
      sub="Application support cases assigned to this advisor"
    >
            ...
            <tbody>
              {rows.length === 0 ? (
                <tr>
                  ...
                  >
                    No applications assigned to this advisor.
                  </td>
                </tr>
              ) : (
                rows.map((row) => {
