    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      ...
      >
        ...
        <p className="mt-2 text-[13px] text-[#666]">
          Upload an Excel file (.xlsx) that matches the sample template. Existing universities are
          matched by <strong>name</strong> and updated; new names are added. Keep the name column
          unchanged when editing a row. Duplicate names in the same file are skipped. CSV is also
          accepted.
        </p>
