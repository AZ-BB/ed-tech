...
import { SchoolNotificationsPanel } from "./school-notifications-panel";
import { useSchoolNotificationsPoll } from "./use-school-notifications-poll";

export function SchoolNotificationsButton() {
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        aria-expanded={open}
        aria-controls="school-notifications-panel"
