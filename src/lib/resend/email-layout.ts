...
/** Desktop email card width; mobile layout is unchanged below 620px. */
export const EMAIL_DESKTOP_MAX_WIDTH_PX = 960;
...
<body style="margin:0;padding:0;background:#f4f3ee;font-family:system-ui,-apple-system,Segoe UI,Roboto,sans-serif;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="email-outer" style="background:#f4f3ee;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="email-card" style="max-width:${EMAIL_DESKTOP_MAX_WIDTH_PX}px;background:#ffffff;border-radius:12px;border:1px solid #e5e2d8;overflow:hidden;">
