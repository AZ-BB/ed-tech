    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:12px;border:1px solid #e5e2d8;overflow:hidden;">
        ...
        <tr><td style="padding:16px 28px 28px;border-top:1px solid #eee9dc;">
          <p style="margin:0;font-size:12px;line-height:1.5;color:#7a8a80;">This link is private. Do not share it publicly. If the button doesn't work, copy this URL into your browser:<br><a href="${submitUrl}" style="color:#2d6a4f;word-break:break-all;">${submitUrl}</a></p>
        </td></tr>
      </table>
    </td></tr>
  </table>
