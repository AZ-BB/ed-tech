...
export const footerEn = {
  tagline:
    "A MENA-focused university guidance platform built for schools, students, and families.",
  platform: "Platform",
  company: "Company",
  legal: "Legal",
  blog: "Blog",
  ...
  privacy: "Privacy",
  terms: "Terms",
  copyright: "© 2026 Univeera. All rights reserved.",
} as const;
...
export const contactEn = {
  ...
  responseTime: "We usually respond within 2-4 hours.",
  fullName: "Full name",
...
export const blogEn = {
  title: "Blog",
  subtitle:
    "We're working on thoughtful content, guides, and updates for students, families, and partners.",
...
export const authEn = {
  ...
  logIn: "Log in",
  newHere: "New here?",
  startUniversityJourney: "Start your university journey",
  createAccountSubtitle: "Create your account in under 2 minutes",
  createAccount: "Create account",
  schoolDeactivated: "The school has been deactivated. Please contact support.",
  ...
  chooseNewPasswordSubtitle: "Enter a new password for your Univeera account.",
  ...
  signupCredentials: "Set up your login credentials",
} as const;
...
export const homeEn = {
  ...
  testimonials: [
    {
      quote:
        "I had no idea where to start. The AI matching helped me shortlist universities that actually fit my profile and goals.",
      name: "Noura A.",
      uni: "Accepted — University of Manchester 🇬🇧",
    },
    {
      quote:
        "My personal statement felt weak, but the AI essay feedback pushed me to rewrite it and really stand out.",
      name: "Mohammed K.",
      uni: "Accepted — NYU Abu Dhabi 🇦🇪",
    },
    {
      quote:
        "I was unsure about studying abroad. Speaking to someone already there gave me the clarity and confidence to apply.",
      name: "Sara R.",
      uni: "Accepted — University of Toronto 🇨🇦",
    },
  ],
  missionLabel: "Our mission",
  missionTitle: "Empowering students across the Middle East to access better education",
  missionDesc:
    "Built by professionals who experienced the challenges of the university application journey firsthand. We believe every student deserves clear guidance, accessible tools, and real support — regardless of background.",
  faqLabel: "FAQ",
