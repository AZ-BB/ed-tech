...
export function buildPostAdmissionPaymentRequestEmailHtml(
  ...
  return wrapEmailHtml({
    bodyHtml: `<p style="margin:0 0 8px;font-size:13px;font-weight:600;letter-spacing:0.04em;text-transform:uppercase;color:#2d6a4f;">Univeera · Post-admission support</p>
