...
export const TOOL_ICONS: Record<string, ReactNode> = {
  ...
  spark: (
    <svg {...iconProps}>
      <path d="M12 3l1.9 4.6L18.5 9l-4.6 1.9L12 15l-1.9-4.1L5.5 9l4.6-1.4zM19 15l.9 2.1L22 18l-2.1.9L19 21l-.9-2.1L16 18l2.1-.9z" />
    </svg>
  ),
  pen: (
    <svg {...iconProps}>
...
export const PTR_ICONS: Record<string, ReactNode> = {
  users: (
    <svg {...ptrIconProps}>
      <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM23 21v-2a4 4 0 0 0-3-3.9M16 3.1a4 4 0 0 1 0 7.8" />
    </svg>
  ...
  award: (
    <svg {...ptrIconProps}>
      ...
      <path d="M8.2 14.2 7 22l5-3 5 3-1.2-7.8" />
    </svg>
  ),
  search: (
    <svg {...ptrIconProps}>
  ...
  cap: (
    <svg {...ptrIconProps}>
      <path d="M22 10L12 5 2 10l10 5 10-5zM6 12v5c0 2 3 4 6 4s6-2 6-4v-5" />
    </svg>
  ),
  school: (
    <svg {...ptrIconProps}>
      <path d="M3 9l9-5 9 5v11H3zM9 22V12h6v10" />
    </svg>
  ),
  globe: (
    <svg {...ptrIconProps}>
