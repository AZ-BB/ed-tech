...
export function CustomSignupForm({
  ...
  const rightPanel = (
    <div className="w-full max-w-md pb-8 pt-1 sm:pt-0 lg:py-0">
      <h2 className="serif text-xl text-[var(--text)] sm:text-2xl">{cs.formTitle}</h2>
      <p className="mb-5 text-sm text-[var(--text-light)]">{cs.formSub}</p>
